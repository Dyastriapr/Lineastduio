...
export default function LandingPage() {
  ...
  const prevSlide = (current: number, setter: React.Dispatch<React.SetStateAction<number>>, max: number) => 
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-20">
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="w-full md:w-1/3 space-y-8 text-center">
              ...
              <a href="https://maps.google.com" target="_blank" className="inline-block bg-zinc-900 text-white px-10 py-4 rounded-full text-sm font-bold uppercase tracking-widest hover:bg-sky-500 transition-colors shadow-lg shadow-zinc-200">Petunjuk Jalan</a>
            </div>
